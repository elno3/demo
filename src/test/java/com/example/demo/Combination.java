...
class Combination { 
	...
	static void combinationUtil(List<Card> listCards, List<Card> outputCombination, int start, 
	...
	{ 
		...
		{ 
			for (int j=0; j<r; j++) 
				System.out.print(outputCombination.get(j)+" "); 
			System.out.println(""); 
			return; 
		} 
	...
	static void printCombination(List<Card> cardList, int n, int r) 
	{ 
		// A temporary array to store all combination one by one 
		List<Card> lisCombination=new ArrayList<Card>(); 

		// Print all combination using temprary array 'data[]' 
		combinationUtil(cardList, lisCombination, 0, n-1, 0, r); 
	} 
